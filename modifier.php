                                ...
                                <div class="row" style="margin-top:-2%;">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <div>
                                        ...
                                        Prix Produit:
                                            <div class="md-form mb-4"><input class="md-form-control" name="prix" type="text"  value="<?PHP echo $prix ?>"  ></div>
                                        Quantité:
                                            <div class="md-form mb-4"><input class="md-form-control" name="quantite" type="text" value="<?PHP echo $quantite ?>" ></div>
                                        URL Image:
                                            <div class="md-form mb-4"><input  name="image" type="text" value="<?PHP echo $image ?>" ></div>
...
if (isset($_POST['modifier'])){
	$produit=new produit($_POST['id'],$_POST['nom'],$_POST['prix'],$_POST['quantite'],$_POST['image']);
