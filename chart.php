...
?>
    ...
    <?PHP
foreach($listeBestcategorie as $row2){
    ?>
                                <tr align="center">
                                    <td><?PHP echo $row2['id_categorie']; ?></td>
                                    <td><?PHP echo $row2['name']; ?></td>
                                    <td><?PHP echo $row2['total_sold']; ?></td>
                                </tr>
<?PHP
}
?>
    ...
    <script type="js/jspdf.js"></script>
    <script type="js/jquery-2.13.js"></script>
    <script type="js/pdfFromHTML.js"></script>
