...
$prom=new promotion("","","","","");
$list=$prom->getPromotion($_POST['idpr']);
foreach($list as $row)
{
?>
<form action="UpdateProm.php" method="POST">
...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="IDPR" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $row['idproduit']; ?>" required >
                                            </td>
...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="date1" type="date" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $row['datedebut']; ?>" required >
                                            </td>
...
<tr>
    ...
    <td>
                                                ...
                                                <input  name="date2" type="date" class="form-control" aria-required="true" aria-invalid="false"value="<?php echo $row['datefin']; }?>" required>
                                                <input type="hidden" name="idp" value="<?php echo $row['idpromotion']; ?>">
                                            </td>
